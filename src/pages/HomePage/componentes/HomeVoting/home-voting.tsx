...
const HomeVoting = () => {
  return (
    <div className='home-voting'>
      ...
      <Link to={'/shows/selecao'} className=' btn-outline-primary home-voting-btn-vote'>
        <div className='home-voting-link-container'>
          ...
          <span className='home-voting-link-text animate__animated'>Realizar minha votacao</span>
        </div>
